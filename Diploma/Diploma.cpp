...
int main()
{
	Vector2<double> vec(2.0, 4.0);
	Vector2<double> sec(3.0, 2.0);

	Array<Vector2<double>> arr1(10);
	Array<Vector2<double>> arr2(10);
    ...
    Matrix<double> mtr1(3, 3);
    Matrix<double> mtr2(3, 3);
    ...
    Vector2<double> lrp = lerp (res, tmp, 0.5);
